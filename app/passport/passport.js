    ...
    function(req, token, refreshToken, profile, done) {
        ...
        process.nextTick(function() {
            ...
            if (!req.user) {    //  If user is not logged in...
                ...
                User.findOne({  //  Find him...
                    where: {"user_facebook.id" : profile.id}
                }).then(function(user){

                    if(user){   //  User exists
                        if(!user.facebook.token){   //  userID knows there is a FB but there is no token
